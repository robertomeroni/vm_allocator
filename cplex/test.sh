...
SEED_NUMBER_VALUES=($(seq 1 5))  # This creates a range from 1 to 20
TIME_STEP_VALUES=(30)
NEW_VMS_PER_STEP_VALUES=(1 3 5 10)
NUM_TIME_STEPS_VALUES=(100)
MASTER_MODEL_VALUES=(
                    'main' 
                    # 'mini'
                    # ''
...
# Check if the initial PM file exists in the original config file
INITIAL_PMS_FILE="simulation/simulation_input/physical_machines.dat"
          ...
          for NUM_TIME_STEPS in "${NUM_TIME_STEPS_VALUES[@]}"; do
            for TIME_STEP in "${TIME_STEP_VALUES[@]}"; do
              for NEW_VMS_PER_STEP in "${NEW_VMS_PER_STEP_VALUES[@]}"; do
                ...
                TEMP_CONFIG_FILE="$TEMP_DIR/config_${USE_RANDOM_SEED}_${SEED_NUMBER}_${TIME_STEP}_${NEW_VMS_PER_STEP}_${NUM_TIME_STEPS}_${MASTER_MODEL}_${MAIN_MODEL_PERIOD}_${MINI_MODEL_PERIOD}.py"
                ...
                OUTPUT_LOG_FILE="$TEMP_DIR/output_${USE_RANDOM_SEED}_${SEED_NUMBER}_${TIME_STEP}_${NEW_VMS_PER_STEP}_${NUM_TIME_STEPS}_${MASTER_MODEL}_${MAIN_MODEL_PERIOD}_${MINI_MODEL_PERIOD}.log"
                ...
                echo "USE_RANDOM_SEED=$USE_RANDOM_SEED, SEED_NUMBER=$SEED_NUMBER, TIME_STEP=$TIME_STEP, NEW_VMS_PER_STEP=$NEW_VMS_PER_STEP, NUM_TIME_STEPS=$NUM_TIME_STEPS, MASTER_MODEL=$MASTER_MODEL, MAIN_MODEL_PERIOD=$MAIN_MODEL_PERIOD, MINI_MODEL_PERIOD=$MINI_MODEL_PERIOD" >> "$RESULTS_FILE"
                ...
                echo "Results for config ${USE_RANDOM_SEED}_${SEED_NUMBER}_${TIME_STEP}_${NEW_VMS_PER_STEP}_${NUM_TIME_STEPS}_${MASTER_MODEL}_${MAIN_MODEL_PERIOD}_${MINI_MODEL_PERIOD}:"
...
python3 get_test_results.py "$RESULTS_FILE"
