...
CPLEX_TIME_LIMIT_MINI_VALUES=(10)
...
TOTAL_TESTS=$(( ${#USE_RANDOM_SEED_VALUES[@]} * ${#SEED_NUMBER_VALUES[@]} * ${#WORKLOAD_NAME_VALUES[@]} * ${#MASTER_MODEL_VALUES[@]} * ${#MAIN_MODEL_PERIOD_VALUES[@]} * ${#MINI_MODEL_PERIOD_VALUES[@]} * ${#NUM_TIME_STEPS_VALUES[@]} * ${#TIME_STEP_VALUES[@]} * ${#STARTING_STEP_VALUES[@]} * ${#NEW_VMS_PER_STEP_VALUES[@]} * ${#USE_WORKLOAD_PREDICTOR_VALUES[@]} * ${#USE_FILTER_VALUES[@]} * ${#safety_margin_values[@]} * ${#step_windows_online_prediction_values[@]} * ${#step_windows_weights_accuracy_values[@]} * ${#w_concurrent_migrations_values[@]} * ${#CPLEX_TIME_LIMIT_MAIN_VALUES[@]} * ${#CPLEX_OPTIMALITY_GAP_MAIN_VALUES[@]} * ${#CPLEX_TIME_LIMIT_MINI_VALUES[@]} * ${#CPLEX_OPTIMALITY_GAP_MINI_VALUES[@]} ))
CURRENT_TEST=0
                                  ...
                                  for cplex_optimality_gap_main in "${CPLEX_OPTIMALITY_GAP_MAIN_VALUES[@]}"; do
                                    for cplex_time_limit_mini in "${CPLEX_TIME_LIMIT_MINI_VALUES[@]}"; do
                                      for cplex_optimality_gap_mini in "${CPLEX_OPTIMALITY_GAP_MINI_VALUES[@]}"; do
                                        ...
                                        echo "safety_margin=$safety_margin, step_window_for_online_prediction=$step_window_for_online_prediction, step_window_for_weights_accuracy=$step_window_for_weights_accuracy, w_concurrent_migrations=$w_concurrent_migrations" >> "$RESULTS_FILE"
                                        ...
                                        echo "safety_margin=$safety_margin, step_window_for_online_prediction=$step_window_for_online_prediction, step_window_for_weights_accuracy=$step_window_for_weights_accuracy, w_concurrent_migrations=$w_concurrent_migrations"
