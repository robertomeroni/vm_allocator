...
main_file="mini_main_scalability_test.mod"
log_dir="logs_scalability_test/mini"
output_dir="${log_dir}/output"
results_file="${log_dir}/scalability_test_results.csv"

# Define the ranges for physical and virtual machines
physical_machines=($(seq 10 10 200))  # Adjust the range as needed
virtual_machines=($(seq 10 10 1000))  # Adjust the range as needed
