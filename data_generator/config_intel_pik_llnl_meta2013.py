...
pm_config = {
    'cpu_capacity': [32, 40, 48, 56, 64, 128, 256],      # Available CPU capacities in cores
    'memory_capacity': [64, 128, 256, 512],    # Available memory capacities in GB
    'speed_range': (1, 1),                         # Speed range for the machines 
    'time_to_turn_on_range': (15.0, 120.0),            # Time to turn on range in seconds
    'time_to_turn_off_range': (10.0, 90.0),            # Time to turn off range in seconds
