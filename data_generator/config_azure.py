...
pm_config = {
    "cpu_capacity": [10, 16, 24, 32, 40, 48],  # Available CPU capacities in cores
    "memory_capacity": [32, 64, 128],  # Available memory capacities in GB
    "speed_range": (1, 1),  # Speed range for the machines
    "time_to_turn_on_range": (10.0, 60.0),  # Time to turn on range in seconds
    "time_to_turn_off_range": (5.0, 30.0),  # Time to turn off range in seconds
