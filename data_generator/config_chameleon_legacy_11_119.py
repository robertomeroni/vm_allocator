...
pm_config = {
    "cpu_capacity": [40],  # Available CPU capacities in cores
    "memory_capacity": [64],  # Available memory capacities in GB
    "speed_range": (1, 1),  # Speed range for the machines
    "time_to_turn_on_range": (20.0, 20.0),  # Time to turn on range in seconds
    "time_to_turn_off_range": (10.0, 10.0),  # Time to turn off range in seconds
