...
@profile
def log_allocation(step, active_vms, terminated_vms_in_step, turned_on_pms, turned_off_pms, pms, cpu_load, memory_load, total_revenue, total_costs, print_to_console=True, log_folder_path=None, previous_state={}):
