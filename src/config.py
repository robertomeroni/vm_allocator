...
STARTING_STEP = 1
TIME_STEP = 40  # Time step in seconds
NUM_TIME_STEPS = 1000000  # Number of time steps to simulate
...
MINI_MODEL_MAX_PMS = 100
MIGRATION_MODEL_MAX_FRAGMENTED_PMS = 50
FAILED_MIGRATIONS_LIMIT = 20
...
POWER_FUNCTION_FILE = os.path.join(
    MODEL_INPUT_FOLDER_PATH, "power_consumption_complete.dat"
)
